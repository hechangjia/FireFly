...
<div style="text-align: center;">
    <ul style="display: inline-block; text-align: left;">
        <li><a href="/posts/thinking_0/">机器学习的核心问题是泛化能力(Generalization)</a></li>
        <li><a href="/posts/thinking_1/">NFL:无免费午餐定理与奥卡姆剃刀</a></li>
    </ul>
</div>
...
> **尤里卡**，**直译：** *我找到了！*。
> 
> 一个源自希腊用以表达发现某件事物、真相时的感叹词。 
>
> [阿基米德原理的发现](https://en.wikipedia.org/wiki/Eureka_(word))
